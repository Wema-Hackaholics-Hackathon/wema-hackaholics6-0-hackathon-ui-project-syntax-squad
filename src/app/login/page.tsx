  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", backgroundColor: "#000000", color: "#f3f4f6" }}>
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        >
          <h2 style={{ margin: 0, fontSize: 18, fontWeight: 800 }}>Login</h2>
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 16 }}>
            ...
            <button className="primary" style={{ padding: "12px 16px", borderRadius: 12, background: "linear-gradient(135deg,#22c55e,#0ea5e9)", color: "white", border: 0, cursor: "pointer", fontWeight: 700 }}>Login</button>
          </form>
        </div>
      </div>
